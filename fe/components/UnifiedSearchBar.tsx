        ...
        >
            ...
            <div className="relative flex items-center gap-2">
                <div className="relative flex-1">
                    <svg
                        className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-secondary-light/70 pointer-events-none"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                    ...
                    <input
                        ...
                        className={`search-input pl-10 ${compact ? 'pr-[6.5rem] py-2 text-sm' : `${query ? 'pr-9' : 'pr-4'} py-3 text-base`}`}
                        autoComplete="off"
                        spellCheck={false}
                        aria-label="Search"
                    />
